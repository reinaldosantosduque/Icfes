...
var CreateJoyaComponent = /** @class */ (function () {
    function CreateJoyaComponent(joyaService, router) {
        this.joyaService = joyaService;
        this.router = router;
        this.joya = new _joya__WEBPACK_IMPORTED_MODULE_2__["Joya"]();
        this.submitted = false;
    }
    CreateJoyaComponent.prototype.ngOnInit = function () {
    };
    CreateJoyaComponent.prototype.newJoya = function () {
        this.submitted = false;
        this.joya = new _joya__WEBPACK_IMPORTED_MODULE_2__["Joya"]();
    };
    CreateJoyaComponent.prototype.save = function () {
        var _this = this;
        this.joyaService
            .createJoya(this.joya).subscribe(function (data) {
            console.log(data);
            _this.joya = new _joya__WEBPACK_IMPORTED_MODULE_2__["Joya"]();
            _this.gotoList();
        }, function (error) { return console.log(error); });
    };
    CreateJoyaComponent.prototype.onSubmit = function () {
        this.submitted = true;
        this.save();
    };
    CreateJoyaComponent.prototype.gotoList = function () {
        this.router.navigate(['/joyas']);
    };
    CreateJoyaComponent.ctorParameters = function () { return [
...
var JoyaListComponent = /** @class */ (function () {
    function JoyaListComponent(joyaService, router, modalService, route) {
        this.joyaService = joyaService;
        this.router = router;
        this.modalService = modalService;
        this.route = route;
    }
    JoyaListComponent.prototype.ngOnInit = function () {
        this.reloadData();
    };
    JoyaListComponent.prototype.reloadData = function () {
        this.joyas = this.joyaService.getJoyasList();
    };
    JoyaListComponent.prototype.deleteJoya = function (id) {
        var _this = this;
    ...
    JoyaListComponent.prototype.updateJoya = function (id) {
        this.router.navigate(['update', id]);
    };
    JoyaListComponent.prototype.openModal = function (id, num) {
        var _this = this;
        this.joya = new _joya__WEBPACK_IMPORTED_MODULE_2__["Joya"]();
    ...
    JoyaListComponent.prototype.closeModal = function (id) {
        this.modalService.close(id);
    };
    JoyaListComponent.ctorParameters = function () { return [
        { type: _joya_service__WEBPACK_IMPORTED_MODULE_1__["JoyaService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
...
var JoyaService = /** @class */ (function () {
    function JoyaService(http) {
        this.http = http;
        this.baseUrl = 'http://localhost:8080/prueba-tecnica/api/joyas';
    }
    JoyaService.prototype.getJoya = function (id) {
        return this.http.get(this.baseUrl + "/" + id);
    };
    JoyaService.prototype.createJoya = function (joya) {
        return this.http.post("" + this.baseUrl, joya);
    };
    JoyaService.prototype.updateJoya = function (id, value) {
        return this.http.put(this.baseUrl + "/" + id, value);
    };
    JoyaService.prototype.deleteJoya = function (id) {
        return this.http.delete(this.baseUrl + "/" + id, { responseType: 'text' });
    };
    JoyaService.prototype.getJoyasList = function () {
        return this.http.get("" + this.baseUrl);
    };
    JoyaService.ctorParameters = function () { return [
...
var UpdateJoyaComponent = /** @class */ (function () {
    function UpdateJoyaComponent(route, router, joyaService) {
        this.route = route;
        this.router = router;
        this.joyaService = joyaService;
    }
    UpdateJoyaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.joya = new _joya__WEBPACK_IMPORTED_MODULE_2__["Joya"]();
    ...
    UpdateJoyaComponent.prototype.updateJoya = function () {
        var _this = this;
    ...
    UpdateJoyaComponent.prototype.onSubmit = function () {
        this.updateJoya();
    };
    UpdateJoyaComponent.prototype.gotoList = function () {
        this.router.navigate(['/joyas']);
    };
    UpdateJoyaComponent.ctorParameters = function () { return [
